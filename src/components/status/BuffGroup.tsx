...
import { hasSkillCategory, Skill, SkillOrigin } from "../../static/skills/skill";
    ...
    return (
        <Card>
            <CardContent>
                ...
                <Grid container>
                    {buffs.filter((buff) => hasSkillCategory(buff, "Buff") || hasSkillCategory(buff, "Passive")).map((buff, index) => (
